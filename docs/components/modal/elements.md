...
- `DYVIX_MODAL_ELEMENT.TEXT`: `'text'`
- `DYVIX_MODAL_ELEMENT.EMAIL`: `'email'`
- `DYVIX_MODAL_ELEMENT.PASSWORD`: `'password'`
- `DYVIX_MODAL_ELEMENT.SEARCH`: `'search'`
- `DYVIX_MODAL_ELEMENT.URL`: `'url'`
- `DYVIX_MODAL_ELEMENT.TEL`: `'tel'`
- `DYVIX_MODAL_ELEMENT.SELECT`: `'select'`
